<div class="hero  ">
  <div class="hero-content flex-col lg:flex-row">
    ...
    <img src="{{ asset('assets/home/our-medical/image1.png') }}" class="max-w-lg rounded-lg " />

    <div>
        <p class="text-gray-400">OUR MEDICAL</p>
      <h1 class="text-5xl font-bold">We're setting Standards in Research what's more, Clinical Care!</h1>
